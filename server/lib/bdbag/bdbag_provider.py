...
class AbstractZipImportProvider(ImportProvider):
    ...
    def _scan_dirs(self, root: _FileTree, dir: pathlib.Path, strip_path: pathlib.Path) -> None:
...
class GenericZipProvider(AbstractZipImportProvider):
...
class BDBagProvider(AbstractZipImportProvider):
    def __init__(self) -> None:
    ...
    def _read_fetch_txt(self, root: _FileTree, main: pathlib.Path) -> None:
    ...
    def _read_bag_dir(self, root: _FileTree, main: pathlib.Path) -> None:
        self._scan_dirs(root, main, main)
