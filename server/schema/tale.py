...
taleModel = {
    ...
    "required": ["dataSet", "imageId"],
    "properties": {
        "_id": {"type": "string", "description": "internal unique identifier"},
        "title": {"type": "string", "description": "Title of the Tale"},
        "description": {
            "type": ["string", "null"],
        ...
        "format": {"type": "integer", "description": "Tale format specification"},
        "public": {
            "type": "boolean",
        ...
        "icon": {"type": "string", "description": "A URL to an image icon"},
        "license": {
            "type": "string",
            "description": "The license that the Tale is under",
        },
        "publishInfo": {"$ref": "#/definitions/publishInfo"},
        "copyOfTale": {
            "type": ["string", "null"],
    ...
    "example": {
        ...
        "dataSet": [
            {"itemId": "5c4887389759c200017b230e", "mountPath": "illustris.jpg"}
        ],
        ...
        "iframe": True,
        "illustration": (
            "https://raw.githubusercontent.com/whole-tale/dashboard/"
